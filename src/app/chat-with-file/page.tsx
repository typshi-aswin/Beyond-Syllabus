...
export default function ChatWithFilePage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-[#181824] dark:to-[#232946] overflow-hidden mt-[10vh]">
      <Header />
        ...
        <main className="flex-1 overflow-hidden flex flex-col items-center justify-center">
          {!showChatInterface ? (
            ...
            <div className="flex flex-col items-center justify-center w-full h-full py-16 px-4 relative">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-center mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">
            ...
            <div className="w-full h-full flex flex-col px-4 py-4 md:container md:mx-auto">
              ...
              <Card className="shadow-lg rounded-2xl bg-card/80 backdrop-blur-sm border flex-1 flex flex-col min-h-0">
                <CardContent className="flex flex-col p-3 md:p-4 h-full">
                  ...
                  <div
                    className="flex-1 overflow-y-auto scroll-smooth pr-1 md:pr-2"
                    style={{
                      scrollbarWidth: "thin",
                      scrollbarColor:
                        "hsl(var(--muted-foreground) / 0.2) transparent",
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="relative group max-w-[85%] sm:max-w-md md:max-w-lg">
                                <div
                                  className={`rounded-2xl px-3 py-2 md:px-4 md:py-3 text-sm md:text-base shadow-md prose prose-sm dark:prose-invert prose-headings:font-semibold prose-p:my-2 prose-ul:my-2 prose-li:my-0.5 ${
                                    msg.role === "user"
                      ...
                      {suggestions.length > 0 && !loading && (
                        <div className="flex flex-col gap-2 mt-4 md:mt-6">
                          ...
                          {suggestions.map((s, i) => (
                            <div
                              key={i}
                              className="flex items-center justify-between w-full border-b border-border/50 pb-2"
                            >
                              <Button
