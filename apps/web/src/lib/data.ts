                    ...
                    modules: [
                      {
                        ...
                        content:
                          "Solving systems of linear equations using matrices, row echelon form, determinants.",
                      },
                      {
                        title: "Vector Spaces",
                        content:
                      ...
                      },
                      {
                        ...
                        content:
                          "Kernel and range of a linear transformation, eigenvalues and eigenvectors, diagonalization.",
                      },
                      {
                        title: "Differential Calculus",
                        content:
                          "Limits, continuity, derivatives, mean value theorem, applications of derivatives.",
                      },
                      {
                        title: "Integral Calculus",
                        content:
                          "Fundamental theorem of calculus, techniques of integration, applications of integrals.",
                      },
                    ],
                  },
                  {
                    ...
                    modules: [
                      {
                        title: "Mechanics",
                        content:
                          "Newton's laws, work and energy, rotational motion, simple harmonic motion.",
                      },
                      {
                        title: "Optics",
                        content:
                          "Interference, diffraction, polarization of light, lasers and optical fibers.",
                      },
                      {
                        title: "Electromagnetism",
                        content:
                          "Maxwell's equations, electromagnetic waves, Poynting vector.",
                      },
                      {
                        title: "Quantum Mechanics",
                        content:
                          "Introduction to quantum theory, Schrodinger equation, wave-particle duality.",
                      },
                      {
                        title: "Thermodynamics",
                        content:
                          "Laws of thermodynamics, entropy, heat engines, refrigeration.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        ...
                        content:
                          "Rate of reaction, order and molecularity, activation energy.",
                      },
                      {
                        title: "Electrochemistry",
                        content:
                          "Electrochemical cells, Nernst equation, corrosion and its prevention.",
                      },
                      {
                        title: "Spectroscopy",
                        content:
                          "UV-Visible, IR, and NMR spectroscopy and their applications.",
                      },
                      {
                        title: "Water Technology",
                        content:
                          "Hardness of water, treatment methods, desalination.",
                      },
                      {
                        title: "Polymer Chemistry",
                        content:
                          "Classification of polymers, plastics, rubbers, conducting polymers.",
                      },
                    ],
                  },
                  {
                    ...
                    modules: [
                      {
                        ...
                        content:
                          "Forces in a plane, resultant of forces, equilibrium of a particle.",
                      },
                      {
                        title: "Equilibrium of Rigid Bodies",
                        content:
                          "Free-body diagrams, types of supports, moments and couples.",
                      },
                      {
                        title: "Properties of Surfaces and Solids",
                        content:
                          "Centroids, moment of inertia, polar moment of inertia.",
                      },
                      {
                        title: "Dynamics of Particles",
                        content:
                          "Kinematics and kinetics of particles, Newton's second law, work-energy principle.",
                      },
                      {
                        title: "Friction",
                        content:
                          "Laws of dry friction, wedges, screws, and belt friction.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        ...
                        content:
                          "Arrays, Stacks, Queues, and their applications. Asymptotic notations for complexity analysis.",
                      },
                      {
                        title: "Linked Lists",
                        content:
                          "Singly, Doubly, and Circular linked lists. Operations like insertion, deletion, and traversal.",
                      },
                      {
                        title: "Trees",
                        content:
                          "Binary Trees, Binary Search Trees (BST), Tree Traversals (In-order, Pre-order, Post-order), AVL Trees, B-Trees.",
                      },
                      {
                        title: "Graphs",
                        content:
                          "Representation of Graphs (Adjacency Matrix, Adjacency List), Traversal algorithms (BFS, DFS), Spanning Trees.",
                      },
                      {
                        title: "Hashing and Heaps",
                        content:
                          "Hash functions, collision resolution techniques. Heap data structure, Min-Heap, Max-Heap, Heap Sort.",
                      },
                    ],
                  },
                  {
                    ...
                    modules: [
                      {
                        ...
                        content:
                          "Binary, Octal, Hexadecimal numbers, conversions. BCD, Gray codes, ASCII.",
                      },
                      {
                        title: "Boolean Algebra & Logic Gates",
                        content:
                          "Boolean postulates and laws. De-Morgan's Theorem. Logic gates, Universal gates.",
                      },
                      {
                        title: "Combinational Logic Circuits",
                        content:
                          "Adders, Subtractors, Multiplexers, Demultiplexers, Decoders, Encoders.",
                      },
                      {
                        title: "Sequential Logic Circuits",
                        content:
                          "Flip-flops (SR, JK, T, D), registers, shift registers, ripple and synchronous counters.",
                      },
                      {
                        title: "Memory and Programmable Logic",
                        content: "RAM, ROM, PROM, EPROM. PLA, PAL.",
                      },
                    ],
                  },
                ],
...
Module 5: Processing unit.`,
                    modules: [
                      ...
                      },
                      {
                        ...
                        content:
                          "Some fundamental concepts, execution of a complete instruction, multiple bus organization, hard-wired control, microprogrammed control.",
                      },
                    ],
                  },
                  {
                    ...
                    modules: [
                      {
                        title: "Introduction",
                        content:
                          "Database system architecture, data models, database users and administrator.",
                      },
                      {
                      ...
                      },
                      {
                        title: "SQL",
                        content:
                          "Data definition, data manipulation, and transaction control. Views, indexes, and sequences.",
                      },
                      {
                      ...
                      },
                      {
                        title: "Transactions",
                        content:
                          "ACID properties, concurrency control, locking protocols, recovery management.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        title: "Introduction",
                        content:
                          "Operating system structure, services, system calls, virtual machines.",
                      },
                      {
                        title: "Process Management",
                        content:
                          "Process concept, scheduling, operations on processes, interprocess communication.",
                      },
                      {
                        title: "Synchronization & Deadlocks",
                        content:
                          "Critical-section problem, semaphores, monitors, deadlock characterization and handling.",
                      },
                      {
                        title: "Memory Management",
                        content:
                          "Swapping, paging, segmentation, virtual memory, demand paging.",
                      },
                      {
                        title: "Storage Management",
                        content:
                          "File system interface, implementation, disk scheduling, RAID structure.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        title: "Introduction",
                        content:
                          "Network edge, core, access networks, physical media, OSI and TCP/IP models.",
                      },
                      {
                        title: "Application Layer",
                        content:
                          "Principles of network applications, Web and HTTP, FTP, email, DNS.",
                      },
                      {
                        title: "Transport Layer",
                        content:
                          "Multiplexing and demultiplexing, connectionless transport (UDP), principles of reliable data transfer (TCP).",
                      },
                      {
                        title: "Network Layer",
                        content:
                          "Virtual circuit and datagram networks, router, IP, routing algorithms.",
                      },
                      {
                        title: "Link Layer",
                        content:
                          "Error detection and correction, multiple access links and protocols, LANs.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        title: "Introduction",
                        content:
                          "History of AI, intelligent agents, environments.",
                      },
                      {
                        title: "Search",
                        content:
                          "Uninformed and informed search strategies, adversarial search.",
                      },
                      {
                        title: "Knowledge Representation",
                        content: "Logic, ontologies, semantic networks.",
                      },
                      {
                    ...
                    modules: [
                      {
                        title: "Introduction",
                        content:
                          "Security attacks, services, and mechanisms, a model for network security.",
                      },
                      {
                        title: "Symmetric Ciphers",
                        content:
                          "Classical encryption techniques, block ciphers and the Data Encryption Standard (DES), Advanced Encryption Standard (AES).",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        content: "IPSec, SSL, TLS, PGP, S/MIME.",
                      },
                      {
                        title: "System Security",
                        content:
                          "Intruders, viruses and related threats, firewalls.",
                      },
                    ],
                  },
                ],
...
Module 5: File Handling and Modules.`,
                    modules: [
                      ...
                      },
                      {
                        title: "Control Flow",
                        content:
                          "Conditional statements (if-else), loops (for, while), functions.",
                      },
                      {
                      ...
                      },
                      {
                        title: "File Handling",
                        content:
                          "Reading from and writing to files. Using Python modules.",
                      },
                    ],
                  },
                ],
...
Module 5: Inheritance and Polymorphism.`,
                    modules: [
                      ...
                      },
                      {
                        ...
                        content:
                          "If-else, loops, switch-case. Functions and recursion.",
                      },
                      {
                        title: "Arrays and Pointers",
                        content:
                          "Working with arrays, understanding pointers and memory management.",
                      },
                      {
                        title: "OOP Concepts",
                        content:
                      ...
                      },
                      {
                        ...
                        content:
                          "Implementing inheritance, virtual functions, and polymorphism.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        ...
                        content:
                          "Heaps, Balanced Trees (AVL, Red-Black), Tries.",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        content:
                          "Dijkstra's, Floyd-Warshall, Kruskal's, Prim's algorithms.",
                      },
                      {
                        title: "Complexity",
                        content:
                      ...
                      },
                      {
                        title: "Advanced Topics",
                        content:
                          "String matching algorithms, computational geometry.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        ...
                        content:
                          "Distributed databases, data warehousing, OLAP.",
                      },
                      {
                        title: "NoSQL Databases",
                        content:
                          "Key-value stores, document databases, graph databases (e.g., MongoDB, Neo4j).",
                      },
                      {
                        title: "Big Data",
                        content:
                          "Introduction to Hadoop, Spark, and cloud database solutions.",
                      },
                      {
                        title: "Query Optimization",
                        content:
                          "Advanced indexing, query execution plans, performance tuning.",
                      },
                      {
                        title: "Database Security",
                        content:
                          "Access control, encryption, data privacy regulations.",
                      },
                    ],
                  },
                ],
...
Module 5: OS Security.`,
                    modules: [
                      {
                        title: "Modern OS Concepts",
                        content:
                          "Microkernels, monolithic kernels, hybrid kernels.",
                      },
                      {
                        title: "Concurrency",
                        content:
                          "Multithreading, race conditions, advanced synchronization.",
                      },
                      {
                        title: "Virtualization",
                        content:
                          "Hypervisors, containers (Docker), cloud computing concepts.",
                      },
                      {
                        title: "Distributed OS",
                        content:
                          "Architecture, communication, and synchronization in distributed systems.",
                      },
                      {
                        title: "OS Security",
                        content:
                          "Modern security threats, secure boot, access control models.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        title: "SDN",
                        content:
                          "Architecture, control plane, data plane, OpenFlow.",
                      },
                      {
                        title: "NFV",
                        content:
                          "Concepts, architecture, virtualized network functions.",
                      },
                      {
                        title: "Wireless Networks",
                        content: "5G, Wi-Fi 6, mobile IP, ad-hoc networks.",
                      },
                      {
                        title: "Network Security",
                        content:
                          "Firewalls, IDS/IPS, VPNs, modern cryptographic protocols.",
                      },
                      {
                        title: "IoT Networking",
                        content: "Protocols (MQTT, CoAP), low-power WANs.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        title: "Foundations",
                        content:
                          "Advanced search algorithms, Bayesian networks.",
                      },
                      {
                        title: "Deep Learning",
                        content:
                          "CNNs, RNNs, Transformers, Generative Models (GANs, VAEs).",
                      },
                      {
                        title: "NLP",
                        content:
                          "Language models, sentiment analysis, machine translation.",
                      },
                      {
                        title: "Reinforcement Learning",
                        content:
                          "Q-learning, policy gradients, deep Q-networks.",
                      },
                      {
                        title: "AI Ethics",
                        content:
                          "Bias, fairness, accountability, and transparency in AI.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        ...
                        content:
                          "Identifying a problem, defining scope and objectives.",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        content: "Developing the project based on the design.",
                      },
                      {
                        title: "Evaluation",
                        content: "Testing the project and analyzing results.",
                      },
                      {
                        title: "Presentation",
                        content:
                          "Documenting the project and presenting the findings.",
                      },
                    ],
                  },
                ],
                    ...
                    modules: [
                      {
                        ...
                        content:
                          "Energy bands in solids, charge carriers, drift and diffusion currents.",
                      },
                      {
                        title: "P-N Junction Diode",
                        content:
                          "Formation of P-N junction, V-I characteristics, Zener diode, rectifiers.",
                      },
                      {
                        title: "Bipolar Junction Transistors (BJT)",
                        content:
                          "Construction, operation, configurations (CB, CE, CC), biasing.",
                      },
                      {
                        title: "Field-Effect Transistors (FET)",
                        content:
                          "JFET, MOSFET (Enhancement and Depletion types), characteristics.",
                      },
                      {
                        title: "Power Devices and Display Devices",
                        content: "SCR, DIAC, TRIAC. LED, LCD, Photo-diodes.",
                      },
                    ],
                  },
                  {
                    ...
                    modules: [
                      {
                        ...
                        content: "Binary, octal, hexadecimal, BCD, Gray code.",
                      },
                      {
                        title: "Logic Gates",
                        content:
                          "AND, OR, NOT, NAND, NOR, XOR, XNOR gates. Universal gates.",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        content:
                          "Flip-flops, registers, counters, state machines.",
                      },
                      {
                        title: "Digital ICs",
                        content:
                          "TTL, CMOS, ECL logic families, characteristics and specifications.",
                      },
                    ],
                  },
                ],
