...
import { orpc } from "@/lib/orpc"; // ✅ ORPC import
...
export default function SelectionForm() {
  ...
  const handleSubmit = async (semesterId?: string) => {
    if (
      ...
      setIsLoading(true);
      setLoadingMessage("Loading syllabus...");
      await new Promise((resolve) => setTimeout(resolve, 800));

      // Navigate to syllabus page
      router.push(
        `/${selectedUniversityId}/${selectedProgramId}/${selectedSchemeId}/${
  ...
  if (isError)
    return (
      <ErrorDisplay
        errorMessage={
          error?.message || "An error occurred while fetching syllabus"
        }
      />
    );
                    ...
                    >
                      <div className="space-y-6 flex flex-col items-center justify-center rounded-2xl p-6">
                        ...
                        <Select onValueChange={handleUniversitySelect}>
                          ...
                          <SelectContent className="w-[320px] rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                    ...
                    >
                      <div className="space-y-6 flex flex-col items-center justify-center rounded-2xl p-6">
                        ...
                        >
                          ...
                          <SelectContent className="w-[320px] rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 max-h-[300px] overflow-y-auto">
                        ...
                        <div className="flex items-center gap-2 justify-center">
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>
                                  Your syllabus depends on the academic scheme
                                  you follow.
                                </p>
                              </TooltipContent>
                            </Tooltip>
